// Monte Carlo Needles (Buffon's Needle) - OpenMP Dynamic Scheduling
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <time.h>
...
int main(int argc, char *argv[]) {
    ...
    // Dynamic scheduling: asigna chunks dinámicamente a threads disponibles
    // Mejor para carga desbalanceada, pero más overhead
    #pragma omp parallel for reduction(+:hits) schedule(dynamic, 1000)
    ...
    printf("Buffon's Needle (OpenMP Dynamic): PI estimado = %.8f\n", pi);
