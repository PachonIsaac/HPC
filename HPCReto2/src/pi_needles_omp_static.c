// Monte Carlo Needles (Buffon's Needle) - OpenMP Static Scheduling
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <time.h>
...
int main(int argc, char *argv[]) {
    ...
    // Static scheduling: divide iteraciones en chunks de tamaño fijo
    // Mejor para carga balanceada y menor overhead
    ...
    printf("Buffon's Needle (OpenMP Static): PI estimado = %.8f\n", pi);
